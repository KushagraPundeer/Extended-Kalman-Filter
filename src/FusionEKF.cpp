...
FusionEKF::FusionEKF() {
  ...
  ekf_.P_ = MatrixXd(4,4); // 4 x 4 matrix
  ...
  ekf_.F_ = MatrixXd(4,4); // 4 x 4 matrix state transition
...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  // dt^4/4
  double dt_4_by_4 = dt_4 / 4;

  // dt^3/2
  double dt_3_by_2 = dt_3 / 2;
  ...
  ekf_.Q_ << dt_4_by_4 * noise_ax, 0, dt_3_by_2 * noise_ax, 0,
             ...
             0, dt_3_by_2 * noise_ay, 0, dt_2 * noise_ax;
